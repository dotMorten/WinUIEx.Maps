# WinUIEx.Maps documentation

These guides start with a minimal map and build toward custom data, interaction, and
...
The guides describe the built-in control behavior. Your application remains responsible
for the licensing, attribution, authentication, accessibility, and usage requirements of
its own data, custom layers, and interactive content.
